...
public class DeepslateMillStoneRenderer extends MillstoneRenderer {

    public DeepslateMillStoneRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected SuperByteBuffer getRotatedModel(MillstoneBlockEntity be, BlockState state) {
        return CachedBufferer.partial(DecoPartialModels.DEEPSLATE_MILLSTONE_COG, state);
    }
}

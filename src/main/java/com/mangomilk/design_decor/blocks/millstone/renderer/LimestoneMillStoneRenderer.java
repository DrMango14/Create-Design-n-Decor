...
public class LimestoneMillStoneRenderer extends MillstoneRenderer {
    ...
    public LimestoneMillStoneRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected SuperByteBuffer getRotatedModel(MillstoneBlockEntity be, BlockState state) {
        return CachedBufferer.partial(DecoPartialModels.LIMESTONE_MILLSTONE_COG, state);
    }
}

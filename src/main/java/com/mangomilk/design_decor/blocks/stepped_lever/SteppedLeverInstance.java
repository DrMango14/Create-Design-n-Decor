...
//	protected final ModelData indicator;
	...
	public SteppedLeverInstance(MaterialManager materialManager, SteppedLeverBlockEntity blockEntity) {
		...
		handle = mat.getModel(CDDPartialModels.STEPPED_LEVER_HANDLE, blockState)
			.createInstance();
...
//
		...
		AttachFace face = blockState.getValue(SteppedLeverBlock.FACE);
		rX = face == AttachFace.FLOOR ? 0 : face == AttachFace.WALL ? 90 : 180;
		rY = AngleHelper.horizontalAngle(blockState.getValue(SteppedLeverBlock.FACING));

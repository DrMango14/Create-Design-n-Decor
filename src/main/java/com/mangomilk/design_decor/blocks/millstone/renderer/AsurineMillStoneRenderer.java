...
public class AsurineMillStoneRenderer extends MillstoneRenderer {

    public AsurineMillStoneRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected SuperByteBuffer getRotatedModel(MillstoneBlockEntity be, BlockState state) {
        return CachedBufferer.partial(DecoPartialModels.ASURINE_MILLSTONE_COG, state);
    }
}

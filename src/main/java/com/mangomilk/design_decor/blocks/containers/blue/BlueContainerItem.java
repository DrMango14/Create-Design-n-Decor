...
//
//public class BlueContainerItem extends BlockItem {
//
...
//			return;
//		BlueContainerBlockEntity tankAt = ConnectivityHandler.partAt(CDDBlockEntities.BLUE_CONTAINER.get(), world, placedOnPos);
//		if (tankAt == null)
//			return;

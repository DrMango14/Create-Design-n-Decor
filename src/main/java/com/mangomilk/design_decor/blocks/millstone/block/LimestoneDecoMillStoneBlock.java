...
public class LimestoneDecoMillStoneBlock extends MillstoneBlock {
    public LimestoneDecoMillStoneBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntityType<? extends MillstoneBlockEntity> getBlockEntityType() {
        return CDDBlockEntities.LIMESTONE_MILLSTONE.get();
    }
}

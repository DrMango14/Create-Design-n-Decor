...
public class CrimsiteMillStoneRenderer extends MillstoneRenderer {

    public CrimsiteMillStoneRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected SuperByteBuffer getRotatedModel(MillstoneBlockEntity be, BlockState state) {
        return CachedBufferer.partial(DecoPartialModels.CRIMSITE_MILLSTONE_COG, state);
    }
}

...
public class GraniteDecoMillStoneBlock extends MillstoneBlock {
    public GraniteDecoMillStoneBlock(Properties properties) {
        super(properties);
    }
    ...
    public BlockEntityType<? extends MillstoneBlockEntity> getBlockEntityType() {
        return CDDBlockEntities.GRANITE_MILLSTONE.get();
    }
}

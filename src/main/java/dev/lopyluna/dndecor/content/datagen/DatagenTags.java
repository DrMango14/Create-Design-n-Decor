...
public class DatagenTags {
    ...
    private static void genItemTags(RegistrateTagsProvider<Item> provIn) {
        ...
        prov.tag(DnDecorTags.commonItemTag("assets/create/crushing_wheels")).add(AllBlocks.CRUSHING_WHEEL.asItem());
        prov.tag(DnDecorTags.commonItemTag("assets/create/millstones")).add(AllBlocks.MILLSTONE.asItem());
        prov.tag(DnDecorTags.commonItemTag("assets/create/flywheels")).add(AllBlocks.FLYWHEEL.asItem());
        prov.tag(DnDecorTags.commonItemTag("assets/create/display_boards")).add(AllBlocks.DISPLAY_BOARD.asItem());

...
public class DnDCogwheelBlockItem extends BlockItem {
    ...
    public DnDCogwheelBlockItem(DnDCogWheelBlock block, Properties builder) {
        super(block, builder);
        large = block.isLarge;
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            if (!ICogWheel.isLargeCog(state)) {
                ...
                for (Direction dir : directions) {
                    ...
                    if (!DnDCogWheelBlock.isValidCogwheelPosition(false, world, newPos, axis))
                        continue;
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            if (ICogWheel.isLargeCog(state)) {
                ...
                for (Direction dir : directions) {
                    ...
                    if (!DnDCogWheelBlock.isValidCogwheelPosition(true, world, newPos, dir.getAxis()))
                        continue;
    ...
    public abstract static class DiagonalCogHelper implements IPlacementHelper {
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction dir : directions) {
                ...
                if (!DnDCogWheelBlock.isValidCogwheelPosition(ICogWheel.isLargeCog(state), world, newPos, axis))
                    continue;
    ...
    public static class IntegratedLargeCogHelper implements IPlacementHelper {
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction d : directions) {
                ...
                if (!DnDCogWheelBlock.isValidCogwheelPosition(false, world, newPos, newAxis))
                    return PlacementOffset.fail();

                return PlacementOffset.success(newPos, s -> s.setValue(DnDCogWheelBlock.AXIS, newAxis));
            }
        ...
        public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
            ...
            for (Direction d : directions) {
                ...
                return PlacementOffset.success()
                        .at(newPos)
                        .withTransform(s -> s.setValue(DnDCogWheelBlock.AXIS, newAxis));
            }

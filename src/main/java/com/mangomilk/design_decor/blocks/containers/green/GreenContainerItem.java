...
//
//public class GreenContainerItem extends BlockItem {
//
...
//			return;
//		GreenContainerBlockEntity tankAt = ConnectivityHandler.partAt(CDDBlockEntities.GREEN_CONTAINER.get(), world, placedOnPos);
//		if (tankAt == null)
//			return;
